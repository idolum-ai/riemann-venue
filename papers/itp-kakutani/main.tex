...
\begin{abstract}
Kakutani's dichotomy (1948) states that for two infinite products of
probability measures whose factor pairs are locally absolutely continuous, the
first is either absolutely continuous or mutually singular with respect to the
second, according to whether the infinite product of the Hellinger affinities
...
by an arbitrary type, and with no absolute-continuity hypothesis in the
...
Two remarks on the hypotheses. The index type is
...
and the checker refuses the equality without that hypothesis. What the squeeze consumes,
...
\subsection{The translate flow: singular without the prime number theorem}
