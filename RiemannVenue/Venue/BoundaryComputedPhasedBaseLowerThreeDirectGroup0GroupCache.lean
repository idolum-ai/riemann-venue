import RiemannVenue.Venue.BoundaryComputedPhasedBaseLowerThreeDirectGroup0LeafCache
import RiemannVenue.Venue.BoundaryComputedPhasedBaseLowerThreeDirectGroup0BumpCache
...
def computedPhasedBaseLowerThreeDirectGroup0PointData : ComputedPhasedBaseActiveBlockVariationData
    computedPhasedBaseLowerThreeModel computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval where
  trig := computedPhasedBaseLowerThreeDirectGroup0Trig
  bump := computedPhasedBaseLowerThreeCompactCell0Shard0PointBump
  forward := computedPhasedBaseLowerThreeDirectGroup0ForwardKernel
  reflected := computedPhasedBaseLowerThreeDirectGroup0ReflectedKernel

def computedPhasedBaseLowerThreeDirectGroup0PointLeaves : ComputedPhasedBaseActiveBlockVariationLeaves
    computedPhasedBaseLowerThreeModel computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval where
  toComputedPhasedBaseActiveBlockVariationData := computedPhasedBaseLowerThreeDirectGroup0PointData
  trig_contains := computedPhasedBaseLowerThreeDirectGroup0Trig_contains
  bump_contains := by
    intro b n x hx
  ...
  forward_contains := by
    ...
    have hx' : x = (computedPhasedBaseLowerThreeCompactCell0Shard0Interval.center : ℝ) := by
      ...
      linarith
    subst x
    exact computedPhasedBaseLowerThreeDirectGroup0ForwardKernel_contains
  reflected_contains := by
    ...
    have hx' : x = (computedPhasedBaseLowerThreeCompactCell0Shard0Interval.center : ℝ) := by
      ...
      linarith
    subst x
    exact computedPhasedBaseLowerThreeDirectGroup0ReflectedKernel_contains

def computedPhasedBaseLowerThreeDirectGroup0GroupOrder0 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder0_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder0 b g).Contains
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (0 : Fin 15) _ _
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder1 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder1_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder1 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (1 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder1, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder2 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder2_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder2 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (2 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder2, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder3 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder3_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder3 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (3 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder3, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder4 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder4_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder4 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (4 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder4, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder5 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder5_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder5 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (5 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder5, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder6 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder6_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder6 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (6 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder6, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder7 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder7_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder7 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (7 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder7, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder8 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder8_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder8 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (8 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder8, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder9 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder9_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder9 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (9 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder9, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder10 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder10_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder10 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (10 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder10, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0GroupOrder11 (b : Fin 3) (g : Fin 4) : RationalInterval :=
...
theorem computedPhasedBaseLowerThreeDirectGroup0GroupOrder11_contains (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0GroupOrder11 b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
  ...
  fin_cases b <;> fin_cases g <;>
    apply RationalInterval.contains_of_center_radius_le
      (computedPhasedBaseActiveBlockSignedCosineGroupCell_contains
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves (11 : Fin 15) _ _
        (by simp [computedPhasedBaseLowerThreeCompactCell0Shard0PointInterval, computedPhasedBaseLowerThreeCompactCell0Shard0Interval,
          RationalInterval.singleton, RationalInterval.Contains])) <;>
    norm_num (config := { maxSteps := 1000000 })
      [computedPhasedBaseLowerThreeDirectGroup0GroupOrder11, computedPhasedBaseActiveBlockSignedCosineGroupCell,
        computedPhasedBaseActiveBlockCosineCell,
        computedPhasedBaseActiveBlockTrigCell,
        computedPhasedBaseLowerThreeDirectGroup0PointLeaves, computedPhasedBaseLowerThreeDirectGroup0PointData, computedPhasedBaseLowerThreeDirectGroup0Trig,
        computedPhasedBaseLowerThreeDirectGroup0TrigRow0, computedPhasedBaseLowerThreeDirectGroup0TrigRow1, computedPhasedBaseLowerThreeDirectGroup0TrigRow2,
...
def computedPhasedBaseLowerThreeDirectGroup0Group (n : Fin 12) (b : Fin 3) (g : Fin 4) :
    RationalInterval := ![
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder0,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder1,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder2,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder3,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder4,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder5,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder6,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder7,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder8,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder9,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder10,
  computedPhasedBaseLowerThreeDirectGroup0GroupOrder11
] n b g

theorem computedPhasedBaseLowerThreeDirectGroup0Group_contains (n : Fin 12) (b : Fin 3) (g : Fin 4) :
    (computedPhasedBaseLowerThreeDirectGroup0Group n b g).Contains
      (∑ k : Fin 5, computedPhasedBaseCoefficient
        (computedPhasedBaseLowerThreeModel.column b (finProdFinEquiv (g, k))) *
        computedPhasedCosineJet n
          ...
          (computedPhasedBaseLowerThreeCompactCell0Shard0Interval.center : ℝ)) := by
  fin_cases n
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder0_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder1_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder2_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder3_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder4_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder5_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder6_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder7_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder8_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder9_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder10_contains b g
  exact computedPhasedBaseLowerThreeDirectGroup0GroupOrder11_contains b g
