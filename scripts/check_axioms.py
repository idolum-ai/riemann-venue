...
EXPECTED_DECLARATIONS = {
    ...
    "RiemannVenue.Venue.computedPhasedBaseMiddleMergedContractPaymentQ_lt_target",
    ...
    "RiemannVenue.Venue.computedPhasedBaseFullFiveInnerOneIntegral_mem",
    "RiemannVenue.Venue.computedPhasedBaseFullFiveInnerTwoIntegral_mem",
    "RiemannVenue.Venue.computedPhasedBaseFullFiveInnerThreeIntegral_mem",
    "RiemannVenue.Venue.computedPhasedBaseFullFiveInnerFourIntegral_mem",
    "RiemannVenue.Venue.computedPhasedBaseCompleteIntegral_mem",
    "RiemannVenue.Venue.completedFourierLaplaceTransform_computedPhasedBase_mem_completeCenter",
    "RiemannVenue.Venue.computedPhased_residual_mem_of_completePayment",
    "RiemannVenue.Venue.computedPhasedAnalyticIntervalCertificateOfCompleteBase",
